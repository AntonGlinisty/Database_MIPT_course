...
VALUES (66, 7, 'Малый зал', '2023-05-06 15:40:00');

-- Узнаем количество сеансов, проходивших 5-го мая:

SELECT count(*) AS sess_count
FROM fs.sessions
WHERE start_time BETWEEN '2023-05-05 00:00:00' AND '2023-05-06 00:00:00';

-- Изменим дату показа фильма для конкретного сеанса(перенос):

UPDATE fs.sessions
SET start_time = '2023-05-06 16:00:00'
WHERE sess_id = 66;
...
VALUES (16, 'Дарья', 'Шиханова', 'female', 24, 2);
