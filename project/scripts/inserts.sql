...
INSERT INTO fs.films (film_id, film_title, rel_date, rel_country, genre, box_office, director)
VALUES (5, 'Назад в будущее', '1985-07-03', 'США', 'фантастика, комедия, приключения', 381, 'Роберт Земекис');

INSERT INTO fs.films (film_id, film_title, rel_date, rel_country, genre, box_office, director)
VALUES (6, 'Остров проклятых', '2010-02-13', 'США', 'триллер, детектив, драма', 295, 'Мартин Скорсезе');

INSERT INTO fs.films (film_id, film_title, rel_date, rel_country, genre, box_office, director)
VALUES (7, 'Корпорация монстров', '2001-10-28', 'США', 'мультфильм, фэнтези, комедия, семейный', 539, 'Пит Доктер, Дэвид Силверман, Ли Анкрич');
...
INSERT INTO fs.films (film_id, film_title, rel_date, rel_country, genre, box_office, director)
VALUES (13, 'Карты, деньги, два ствола', '1998-08-23', 'Великобритания', 'боевик, комедия, криминал', 25, 'Гай Ричи');
...
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (51, 10, 'Большой зал', '2023-05-02 11:00:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (52, 2, 'Большой зал', '2023-05-02 14:25:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (53, 12, 'Малый зал', '2023-05-02 18:40:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (54, 1, 'VIP зал', '2023-05-02 19:10:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (55, 15, 'Большой зал', '2023-05-03 10:25:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (56, 13, 'Малый зал', '2023-05-03 15:50:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (57, 11, 'Малый зал', '2023-05-03 18:00:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (58, 5, 'Большой зал', '2023-05-03 18:30:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (59, 8, 'Малый зал', '2023-05-04 14:50:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (60, 9, 'Большой зал', '2023-05-04 15:20:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (61, 14, 'Большой зал', '2023-05-04 18:05:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (62, 6, 'VIP зал', '2023-05-04 20:10:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (63, 7, 'Большой зал', '2023-05-05 12:50:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (64, 4, 'Малый зал', '2023-05-05 16:00:00');
INSERT INTO fs.sessions (sess_id, film_id, hall_name, start_time) VALUES (65, 3, 'VIP зал', '2023-05-05 20:45:00');

-- insert into fs.spectators

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (1, 'Антон', 'Глинистый', 'male', 19, 3);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (2, 'Александр', 'Гаврилин', 'male', 20, 3);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (3, 'Алексей', 'Зерцалов', 'male', 21, 3);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (4, 'Николай', 'Алексеев', 'male', 20, 1);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (5, 'Евгения', 'Кузнецова', 'female', 19, 2);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (6, 'Ярослав', 'Вербов', 'male', 21, 2);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (7, 'Александр', 'Стешенко', 'male', 19, 3);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (8, 'Богдан', 'Сушков', 'female', 19, 3);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (9, 'Станислав', 'Кидун', 'male', 19, 1);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (10, 'Данила', 'Драчев', 'male', 19, 1);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (11, 'Алексей', 'Струповец', 'male', 19, 2);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (12, 'Алексей', 'Суворов', 'male', 19, 3);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (13, 'Екатерина', 'Прохорчук', 'female', 20, 2);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (14, 'Дарья', 'Богомазова', 'female', 20, 2);

INSERT INTO fs.spectators (spect_id, firstname, surname, sex, age, comp_size)
VALUES (15, 'Антон', 'Шулейко', 'male', 18, 2);
...
VALUES (40, 1, 'Большой зал', '2023-04-26 13:55:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (41, 7, 'Большой зал', '2023-04-27 11:15:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (42, 3, 'Большой зал', '2023-04-27 14:35:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (43, 5, 'Малый зал', '2023-04-27 18:45:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (44, 12, 'VIP зал', '2023-04-27 19:40:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (45, 4, 'Большой зал', '2023-04-28 10:15:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (46, 8, 'Малый зал', '2023-04-28 16:20:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (47, 11, 'Малый зал', '2023-04-28 18:15:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (48, 2, 'Большой зал', '2023-04-29 19:10:00', '2023-05-01 10:00:00');

INSERT INTO fs.history (sess_id, film_id, hall_name, start_time, history)
VALUES (49, 13, 'Малый зал', '2023-05-30 16:30:00', '2023-05-01 10:00:00');